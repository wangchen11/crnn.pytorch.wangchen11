...
class lmdbDataset(Dataset):
    ...
    def __init__(self, root="db", transform=None, target_transform=None):
        annotations_file = f"{root}/db.csv"
        img_dir = f"{root}"
        self.img_labels = pd.read_csv(annotations_file, dtype={0:"string", 1: "string"})
